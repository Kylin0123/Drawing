...
public:
	...
	virtual void translate(int x, int y, bool isEditable) {}; //TODO
	virtual void rotate(float angle, bool isEditable) {}; //TODO
	virtual void scale(float s1, float s2, bool isEditable) {}; //TODO
